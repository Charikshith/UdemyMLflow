...
#############################################################
    ...
    print("Active run id is {}".format(run1.info.run_id)) # a94c9fd8a4cd4b9f912f7d0709125444
    print("Active run name is {}".format(run1.info.run_name)) # bittersweet-colt-842
    mlflow.end_run()
    run = mlflow.last_active_run()
    print("Active run id is {}".format(run.info.run_id)) # a94c9fd8a4cd4b9f912f7d0709125444
    print("Active run name is {}".format(run.info.run_name)) # bittersweet-colt-842